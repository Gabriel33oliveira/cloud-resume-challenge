...
const EDITABLE = [
  ...
  '.project-status', '.project-title', '.project-desc', '.project-tags span', '.project-link',
  '.visitor-label', '.visitor-cap', '.project-block-label', '.project-block p', '.project-bug-title', '.project-bug p',
